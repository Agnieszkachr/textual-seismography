...
Headline readings: chapter 53 is the most anomalous chapter in the book (mean CFI +0.37) with
...
Chapter 40, where the tradition places the main seam, is a caution rather than a result. The step is
there — ch. 39 mean CFI −0.18 against ch. 40 +0.11 — but it is the 13th largest of the 65 chapter
boundaries, and the level does not shift across it: chapters 30–39 average +0.00 against +0.01 for
40–49 (Mann-Whitney p = 0.95). Chapter means are a coarse instrument; the claim this repository
makes is about verses.
...
output/                  per-verse scores and derived tables
